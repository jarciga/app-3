			...
			<div class="card-block">
				<div class="row">
					...
					<div class="col-lg-6">
						<div class="card">
						  <div class="card-header">
						  <h4>Redeem/Renew Sangla Transaction</h4>
						  </div>
						  <ul class="list-group list-group-flush">
						    <li class="list-group-item"><a href="{{ url('/redeemrenewpawntransaction') }}" class="">All Redeem/Renew Sangla Transaction</a></li>
						    <li class="list-group-item"><a href="{{ url('/redeemrenewpawntransaction/create/redeem') }}" class="">Create Redeem Sangla Transaction</a></li>
						    <li class="list-group-item"><a href="{{ url('/redeemrenewpawntransaction/create/renew') }}" class="">Create Renew Sangla Transaction</a></li>
						    <li class="list-group-item d-none"><a href="" class="">Redeem/Renew Sangla Transaction Report</a></li>
						  </ul>
						</div>
					</div>				
				</div>
