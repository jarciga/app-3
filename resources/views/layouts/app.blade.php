...
<body class="app header-fixed aside-menu-fixed aside-menu-hidden">
    <header class="app-header navbar">
        ...
        <a class="navbar-brand pr-0 pl-0" href="{{ route('dashboard') }}" style="display:inline-block; color: #ffffff; text-align: center;"><strong>Santolan Pawnshop</strong></a>

 <!--a class="navbar-brand" href="{{ route('dashboard') }}" style="font-size: 18px; font-weight: normal; text-align: center; color: #ffffff; line-height: 1.0em; background-color:#20a8d8;">Santolan Pawnshop<br />System</a-->
        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('dashboard') }}"><i class="icon-speedometer"></i> Dashboard <span class="badge badge-info invisible">NEW</span></a>
                    </li>
                   ...
                   <li class="nav-title">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-note"></i> New Pawn Trans</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/newpawntransaction') }}"><i class="icon-note"></i> All New Pawn</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/newpawntransaction/create') }}"><i class="icon-note"></i> Add New</a>
                            </li>
                        </ul>
                    </li>

                    <!--li class="nav-item nav-dropdown d-none">
                        <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-note"></i> Renew Pawn Trans</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-note"></i> All Renew Pawn</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-note"></i> Add New</a>
                            </li>
                        </ul>
                    </li-->

                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-note"></i> Redeem/Renew</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/redeemrenewpawntransaction') }}"><i class="icon-note"></i> All Redeem Pawn</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="{{ url('/redeemrenewpawntransaction/create') }}"><i class="icon-note"></i> Add New</a>
                            </li>
                        </ul>
                    </li>                    
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ url('/pawntransaction/report') }}"><i class="icon-puzzle"></i> Reporting</a>
                    </li>
    ...
    <footer class="app-footer">
        ...
        <span class="float-right">
            Powered by <a href="">Jay-ar A. Arciga Jr.</a>
        </span>
    </footer>
    ...
    <!--script src="{{ asset('js/libs/jquery.maskMoney.min.js') }}"></script-->

    <!--script src="{{ asset('js/libs/min/jquery.inputmask.bundle.min.js') }}"></script-->
...
$(function() {
    ...
    $('#new-pawn-transaction input[name="date_loan_granted"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    function(start, end, label) {
        //var years = moment().diff(start, 'years');
         //var maturity_date = $('input[name="date_loan_granted"]').val( moment(end, 'yy/m/d').format('YYYY/MM/DD') );
        var maturity_date = $('#new-pawn-transaction input[name="maturity_date"]').val( moment(end, 'yy/m/d').add(1, 'month').format('MM/DD/YYYY') );
        var expiry_date_of_redemption_period = $('#new-pawn-transaction input[name="expiry_date_of_redemption_period"]').val( moment(end, 'yy/m/d').add(4, 'month').format('MM/DD/YYYY') );
    });

    $('#new-pawn-transaction input[name="maturity_date"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    function(start, end, label) {
        //var years = moment().diff(start, 'years');
        var expiry_date_of_redemption_period = $('#new-pawn-transaction input[name="expiry_date_of_redemption_period"]').val( moment(end, 'yy/m/d').add(4, 'month').format('MM/DD/YYYY') );
        //$('input[name="expiry_date_of_redemption_period"]').val();
    });

    $('#new-pawn-transaction input[name="expiry_date_of_redemption_period"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    function(start, end, label) {
        //var expiry_date_of_redemption_period = $('input[name="expiry_date_of_redemption_period"]').val( moment(end, 'yy/m/d').add(4, 'month').format('YYYY/MM/DD') );
    });

    //Redeem Pawn Transaction / Renew Pawn Transaction
    $('#redeem-renew-pawn-transaction input[name="date_loan_granted"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    function(start, end, label) {
        //var years = moment().diff(start, 'years');
         //var maturity_date = $('input[name="date_loan_granted"]').val( moment(end, 'yy/m/d').format('YYYY/MM/DD') );
        /*var maturity_date = $('#new-pawn-tranaction input[name="maturity_date"]').val( moment(end, 'yy/m/d').add(1, 'month').format('MM/DD/YYYY') );
        var expiry_date_of_redemption_period = $('#new-pawn-tranaction input[name="expiry_date_of_redemption_period"]').val( moment(end, 'yy/m/d').add(4, 'month').format('MM/DD/YYYY') );*/
    });


    //Report
    $('input[name="date_range_reporting_from"], input[name="date_range_reporting_to"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    //Loan amount same as principal
    $("#new-pawn-transaction #loan-amount-in-numbers").keyup(function() {
        $("#principal").val($("#loan-amount-in-numbers").val());

        var principal = $("#principal").val();
        var service_charge_in_amount = $("#service-charge-in-amount").val();
        var net_proceeds = (principal - service_charge_in_amount);
        
        //console.log(net_proceeds);
        //console.log(Math.round(net_proceeds));
        console.log(net_proceeds === parseInt(net_proceeds));

        if (net_proceeds === parseInt(net_proceeds)) {
            $("#net-proceeds").val(net_proceeds);  
        } else {
            $("#net-proceeds").val(net_proceeds.toFixed(2));  
        }
    });

    $("#redeem-renew-pawn-transaction #loan-amount-in-numbers").keyup(function() {
        $("#principal").val($("#loan-amount-in-numbers").val());
    });
    
    
    //Auto compute
    $("#new-pawn-transaction #service-charge-in-amount").keyup(function() {
        //console.log($("#service-charge-in-amount").val());
        var principal = $("#principal").val();
        var service_charge_in_amount = $("#service-charge-in-amount").val();
    ...
    //Currency Formatter
    //$(".currency").inputmask({ alias: "currency", 'digits': 2});
    //$(".currency").inputmask('999,999,999.99', { numericInput: true });    //123456  =>  € ___.__1.234,56
    //$(".currency").inputmask('999,999,999.99', { numericInput: true }); 
   // $(".decimal").inputmask();
});
</script>
...
<script>
    ...
    $(function () {
        ...
        jQuery("#identification-card").blur(function () {
            jQuery("#identification-card").attr("disabled","disabled");
        });
...
<script>
    ...
    $(function () {
        ...
        //console.log('{{ url('/newpawntransaction/getdatatablesobjectdata') }}');

        //Start: New Pawn Transaction | DataTable
        var oTable = $('#new-pawn-transaction-table').DataTable({
            ...
            //    "<'row'<'col-md-12'<'col-xs-6'i><'col-xs-6'p>>>",
                ...
                ajax: {
                    ...
                    //url: '{{ url('/newpawntransaction/getdatatablesobjectdata') }}'
                    url: '{{ route('getdatatablesobjectdatanewpawn') }}'
                    /*data: function (d) {
                ...
                order: [[ 2, "asc" ]], //Pawn Ticket Number
                columns: [
                    {data: 'new_pawn_transaction_id', name: 'customers.id'},
                    {data: 'full_name', name: 'customers.full_name'},
                    {data: 'pawn_ticket_number', name: 'mortgages.pawn_ticket_number'},
        ...
        //End: New Pawn Transaction | DataTable


        //Start: Renew Pawn Transaction | DataTable         
        var oTable = $('#renew-pawn-transaction-table').DataTable({
            //dom: "<'row'<'col-md-12'<'col-xs-6'l><'col-xs-6'p>>r>"+
            //    "<'row'<'col-md-12't>>"+
            //    "<'row'<'col-md-12'<'col-xs-6'i><'col-xs-6'p>>>",
                processing: true,
                ...
                ajax: {
                    //url: '/pawnshopsystem/public/index.php/eloquent/object-data',
                    //url: '{{ url('/newpawntransaction/getdatatablesobjectdata') }}'
                    url: '{{ route('getdatatablesobjectdatarenewpawn') }}'
                    /*data: function (d) {
                        d.last_name = $('input[name=last_name]').val();
                        d.first_name = $('input[name=first_name]').val();
                        d.pawn_ticket_number = $('input[name=pawn_ticket_number]').val();
                ...
                order: [[ 3, "asc" ]], //Pawn Ticket Number
                columns: [
                    {data: 'renew_pawn_transaction_id', name: 'customers.id'},
                    {data: 'or_number', name: 'mortgages.or_number'},
                    {data: 'full_name', name: 'customers.full_name'},
                    {data: 'pawn_ticket_number', name: 'mortgages.pawn_ticket_number'},
                    {data: 'ref_pawn_ticket_number', name: 'mortgages.ref_pawn_ticket_number'},
                    {data: 'contact_number', name: 'customers.contact_number'},
                    {data: 'created_at', name: 'customers.created_at'},
                    {data: 'action', orderable: false, searchable: false}
                ]
        ...
        //End: Renew Pawn Transaction | DataTable  


        //Start: Redeem Pawn Transaction | DataTable         
        var oTable = $('#redeem-pawn-transaction-table').DataTable({
            //dom: "<'row'<'col-md-12'<'col-xs-6'l><'col-xs-6'p>>r>"+
            //    "<'row'<'col-md-12't>>"+
            //    "<'row'<'col-md-12'<'col-xs-6'i><'col-xs-6'p>>>",
                processing: true,
                ...
                ajax: {
                    //url: '/pawnshopsystem/public/index.php/eloquent/object-data',
                    //url: '{{ url('/newpawntransaction/getdatatablesobjectdata') }}'
                    url: '{{ route('getdatatablesobjectdataredeempawn') }}'
                    /*data: function (d) {
                        d.last_name = $('input[name=last_name]').val();
                        d.first_name = $('input[name=first_name]').val();
                        d.pawn_ticket_number = $('input[name=pawn_ticket_number]').val();
                ...
                order: [[ 3, "asc" ]], //Pawn Ticket Number
                columns: [
                    {data: 'redeem_pawn_transaction_id', name: 'customers.id'},
                    {data: 'or_number', name: 'mortgages.or_number'},
                    {data: 'full_name', name: 'customers.full_name'},
                    {data: 'pawn_ticket_number', name: 'mortgages.pawn_ticket_number'},
                    {data: 'contact_number', name: 'customers.contact_number'},
        ...
        //End: Redeem Pawn Transaction | DataTable 


        //Start: Redeem/Renew Pawn Transaction | DataTable         
        var oTable = $('#redeem-renew-pawn-transaction-table').DataTable({
            //dom: "<'row'<'col-md-12'<'col-xs-6'l><'col-xs-6'p>>r>"+
            //    "<'row'<'col-md-12't>>"+
            //    "<'row'<'col-md-12'<'col-xs-6'i><'col-xs-6'p>>>",
                processing: true,
                ...
                ajax: {
                    //url: '/pawnshopsystem/public/index.php/eloquent/object-data',
                    //url: '{{ url('/newpawntransaction/getdatatablesobjectdata') }}'
                    //url: '{{-- route('getdatatablesobjectdataredeemrenewpawn', ['transaction_type' => $transaction_type]) --}}'
                    url: '{{ route('getdatatablesobjectdataredeemrenewpawn') }}'
                ...
                order: [[ 3, "asc" ]], //Pawn Ticket Number
                columns: [
                    {data: 'redeem_renew_pawn_transaction_id', name: 'customers.id'},
                    {data: 'or_number', name: 'mortgages.or_number'},
                    {data: 'full_name', name: 'customers.full_name'},
                    {data: 'pawn_ticket_number', name: 'mortgages.pawn_ticket_number'},
                    {data: 'ref_pawn_ticket_number', name: 'mortgages.ref_pawn_ticket_number'},
                    //{data: 'contact_number', name: 'customers.contact_number'},
                    {data: 'loan_status', name: 'mortgages.loan_status'},
                    {data: 'created_at', name: 'customers.created_at'},
                    {data: 'action', orderable: false, searchable: false}
                ]
            });
        ...
        //Start: All Pawn Transaction | DataTable         
        var oTable = $('#pawn-transaction-table').DataTable({
            //dom: "<'row'<'col-md-12'<'col-xs-6'l><'col-xs-6'p>>r>"+
            //    "<'row'<'col-md-12't>>"+
            //    "<'row'<'col-md-12'<'col-xs-6'i><'col-xs-6'p>>>",
                processing: true,
                ...
                ajax: {
                    //url: '/pawnshopsystem/public/index.php/eloquent/object-data',
                    //url: '{{ url('/newpawntransaction/getdatatablesobjectdata') }}'
                    url: '{{ route('getdatatablesobjectdataallpawn') }}',
                    data: function (d) {
                        d.full_name = $('input[name=full_name]').val();
                        d.pawn_ticket_number = $('input[name=pawn_ticket_number]').val();
                        d.ref_pawn_ticket_number = $('input[name=ref_pawn_ticket_number]').val();
                        d.contact_number = $('input[name=contact_number]').val();
                        d.identification_card = $('input[name=identification_card]').val();
                    }
                },
                ...
                columns: [
                    ...
                    {data: 'or_number', name: 'mortgages.or_number'},
                    {data: 'full_name', name: 'customers.full_name'},
                    {data: 'loan_status', name: 'mortgages.loan_status'}, //Type
                    {data: 'pawn_ticket_number', name: 'mortgages.pawn_ticket_number'},
                    {data: 'ref_pawn_ticket_number', name: 'mortgages.ref_pawn_ticket_number'},
                    {data: 'contact_number', name: 'customers.contact_number'},
                    {data: 'created_at', name: 'customers.created_at'},
        ...
        //End: All Pawn Transaction | DataTable  
