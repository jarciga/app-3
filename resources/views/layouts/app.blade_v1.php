                   ...
                   <li class="nav-title">
                    ...
                    <li class="nav-item nav-dropdown">
                        ...
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-note"></i> All New Pawn</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link nav-dropdown-toggle" href="#"><i class="icon-note"></i> Redeem Pawn Trans</a>
                        <ul class="nav-dropdown-items">
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-note"></i> All Redeem Pawn</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" href="#"><i class="icon-note"></i> Add New</a>
                            </li>
...
<script type="text/javascript">
$(function() {
    $('.datepicker, input[name="date_loan_granted"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    function(start, end, label) {
        ...
        var maturity_date = $('input[name="maturity_date"]').val( moment(end, 'yy/m/d').add(1, 'month').format('MM/DD/YYYY') );

        var expiry_date_of_redemption_period = $('input[name="expiry_date_of_redemption_period"]').val( moment(end, 'yy/m/d').add(4, 'month').format('MM/DD/YYYY') );

    });

    $('.datepicker, input[name="maturity_date"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
    ...
    $('.datepicker, input[name="expiry_date_of_redemption_period"]').daterangepicker({
        showDropdowns: true,
        dateFormat: 'yy/m/d',
        singleDatePicker: true,
        showDropdowns: true
