    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <h4 class="card-header">
                <strong>Add New Pawn Transaction</strong>
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        <ul class="nav nav-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link" data-toggle="tab" href="#customer-details" role="tab" aria-controls="customer-details">Customer Details</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link active" data-toggle="tab" href="#pawn-transaction" role="tab" aria-controls="pawn-transaction">Pawn Transaction</a>
                            </li>
                        </ul>
                        <form method="post" action="/pawnshopsystem/public/index.php/store_pawn_customer" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="tab-content">
                                    ...
                                    <!--form method="" action=""-->
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" name="first_name" value="{{ $first_name }}" class="form-control" id="first-name" placeholder="First Name" disabled="disabled">
                                            </div>
                                            

                                            <div class="form-group col-md-3">
                                                <label for="lastname">Last Name</label>
                                                <input type="text" name="last_name" value="{{ $last_name }}" class="form-control" id="last-name" placeholder="Last Name" disabled="disabled">
                                            </div>                           

                                            <div class="form-group col-md-3">
                                                <label for="middlename">Middle Name</label>
                                                <input type="text" name="middle_name" value="{{ $middle_name }}" class="form-control" id="middle-name" placeholder="Middle Name" disabled="disabled">
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="suffix">Suffix</label>
                                                <input type="text" name="suffix" value="{{ $suffix }}" class="form-control" id="suffix" placeholder="Suffix" disabled="disabled">
                                            </div>
                                        ...
                                        <div class="row">    
                                            ...
                                            <div class="form-group col-md-3">
                                                <label for="completeaddress">Complete Address (House Number, Building and Street Name)</label>
                                                 ...
                                                 <textarea name="complete_address" class="form-control" rows="2" id="complete-address" disabled="disabled">{{ $complete_address }}</textarea>
                                            </div>

                                            <div class="form-group col-md-3">
                                                <label for="barangaydistrictlocality">Barangay/District/Locality</label>
                                                <input type="text" name="barangay_district_locality" value="{{ $barangay_district_locality }}" class="form-control" id="barangay-district-locality" placeholder="Barangay/District/Locality" disabled="disabled">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" name="city_municipality" value="{{ $city_municipality }}" class="form-control" id="city-municipality" placeholder="City/Municipality" disabled="disabled">
                                            ...
                                            <div class="form-group col-md-3">
                                                ...
                                                <input type="text" name="province" value="{{ $province }}" class="form-control" id="province" placeholder="Province" disabled="disabled">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select name="identification_card_type" class="form-control" id="identification-card-type" disabled="disabled">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="contact_number" value="{{ $contact_number }}" class="form-control" id="contact-number" placeholder="Contact Number" disabled="disabled">
                                            </div>
                                ...
                                <div class="tab-pane active" id="pawn-transaction" role="tabpanel">
                                    ...
                                    <!--form method="" action=""-->
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-6">  
                                                ...
                                                <textarea id="textarea-input" name="description_of_the_pawn" value="{{ old('description_of_the_pawn') }}" rows="15" class="form-control" placeholder="Descripton of the pawn">{{ old('description_of_the_pawn') }}</textarea>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-actions float-right">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btnSave">Save Pawn Transaction</button>
                                                    <button type="reset" class="btn btn-default">Reset</button>
