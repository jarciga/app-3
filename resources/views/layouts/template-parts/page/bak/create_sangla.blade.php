...
@section('content')
            ...
            <div class="row" style="margin-top:30px;">
                ...
                <div class="col-md-12">
                    ...
                    <form method="post" action="/create_sangla">
                        {{ csrf_field() }}
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="form-actions float-right">
                                                ...
                                                <a class="btn btn-primary btnNext">Continue To Create Sangla Transaction</a>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-actions float-right">
                                                ...
                                                <button type="submit" class="btn btn-primary btnSave">Save Sangla Transaction</button>
                                                <button type="reset" class="btn btn-default">Reset</button>
