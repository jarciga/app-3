...
@section('content')
            ...
            <div class="row" style="margin-top:30px;">
                ...
                <div class="col-md-12">
                    ...
                    <form method="post" action="/create_renew_sangla">
                        {{ csrf_field() }}
                            ...
                            <div class="tab-pane active" id="home" role="tabpanel">
                                    ...
                                    <div class="row">
                                        <div class="form-group col-sm-12">
                                            ...
                                            <input type="hidden" name="customer_number" value="<?php echo 'SPC'.date('Yzn').(customer_count() + 1); ?>">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="form-actions float-right">
                                                ...
                                                <a class="btn btn-primary btnNext">Continue To Create Renew Sangla Transaction</a>
                                        ...
                                        <div class="form-group col-sm-4 ml-sm-auto">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="text" name="pawn_ticket_no" value="" class="form-control" id="pawn-ticket-no" placeholder="Pawn Ticket No.">
                                                </div>                           

                                                <div class="form-group col-sm-12">
                                                    <label for="trackingno">Redeem No.</label>
                                                    <input type="text" name="tracking_no" value="{{ old('pawn_ticket_no') }}" class="form-control" id="tracking-no" placeholder="Redeem No.">
                                                </div>
                                             ...
                                             <div class="row">
                                                ...
                                                <div class="col-sm-6">  
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                       ...
                                                       <textarea id="textarea-input" name="description_of_the_pawn" value="{{ old('description_of_the_pawn') }}" rows="15" class="form-control" placeholder="Descripton of the pawn"></textarea>
                                                    </div>
                                                ...
                                                <div class="col-sm-6"> 
                                                    ...
                                                    <div class="form-group col-sm-12">
                                                        ...
                                                        <div class="col-md-12">
                                                            ...
                                                            Per Annum
                                                                <input type="radio" id="pledge-time-in-period-type" name="pledge_time_in_period_type" value="Per Annum">
                                                            </label>
                                                            <label class="radio-inline" for="permonth">
                                                            Per Month
                                                                <input type="radio" id="pledge-time-in-period-type" name="pledge_time_in_period_type" value="Per Month">
                                                            </label>
                                                            <label class="radio-inline" for="others">
                                                            (Others)
                                                                <input type="radio" id="pledge-time-inperiod-type" name="pledge_time_in_period_type" value="Others">
                                                            </label>
                                                        </div>
                                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-actions float-right">
                                                ...
                                                <button type="submit" class="btn btn-primary btnSave">Save Renew Sangla Transaction</button>
                                                <button type="reset" class="btn btn-default">Reset</button>
