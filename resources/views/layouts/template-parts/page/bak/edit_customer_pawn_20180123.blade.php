    ...
    <div class="col-md-12">
        ...
        <div class="card">
            <h4 class="card-header">
                <strong>Edit Customer &amp; Pawn Transaction</strong>
                            ...
                            <div class="tab-content">
                                <div class="tab-pane active" id="customer-details" role="tabpanel">
                                        ...
                                        <!--div class="row invisible">
                                            ...
                                            <small><strong>Customer No.:</strong> <?php //echo 'SPC-'.date('Ymd').'-'.(customer_count()); ?></small>
                                            <br />
                                            <small><strong>Customer No.:</strong> <?php //echo 'SPC-'.date('Yzn').'-'.(customer_count()); ?></small>
                                            <input type="hidden" name="customer_number" value="<?php //echo 'SPC-'.date('Ymd').'-'.(customer_count()); ?>">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <div class="form-actions float-right">
                                                    ...
                                                    <button type="submit" class="btn btn-primary btnSave">Update Customer &amp; Pawn Transaction</button>
                                                    <button type="reset" class="btn btn-default">Reset</button>
