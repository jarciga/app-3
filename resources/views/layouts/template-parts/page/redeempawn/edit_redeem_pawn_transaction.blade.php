...
<div id="edit-redeem-pawn-tranaction" class="row">

    <div class="col-md-10 offset-md-1">

        <div class="card">
            <h4 class="card-header">
                <strong>Edit | Redeem Pawn Transaction</strong>
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/redeempawntransaction/update') }}/{{$id}}" class="form-horizontal">
                            {{ csrf_field() }}
