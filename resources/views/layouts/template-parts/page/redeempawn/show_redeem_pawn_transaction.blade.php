        ...
        <div class="card">
            <h4 class="card-header">
                ...
                <div class="btn-group pull-right" role="group" aria-label="crud">
                    <a href="{{ url('/redeempawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary">Create</a>
                    <a href="{{ url('/redeempawntransaction/edit') }}/{{$id}}" id="btn-edit-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary">Edit</a>
                </div>
            </h4>
