...
<div id="create-redeem-pawn-tranaction" class="row">

    <div class="col-md-10 offset-md-1">

        <div class="card">
            <h4 class="card-header">
                <strong>Create | Redeem Pawn Transaction</strong>
                <!--a href="{{ url('/redeempawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary pull-right">Create</a-->
            </h4>
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/redeempawntransaction/store') }}" class="form-horizontal">
                            {{ csrf_field() }}
