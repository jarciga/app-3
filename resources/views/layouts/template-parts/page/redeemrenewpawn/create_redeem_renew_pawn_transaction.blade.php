...
<div id="redeem-renew-pawn-transaction" class="row">
    ...
    <div class="col-md-10 offset-md-1">
        ...
        <div class="card">
            <h4 class="card-header">
                <strong>Create | Redeem/Renew Pawn Transaction</strong>
                <!--a href="{{ url('/redeemrenewpawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary pull-right">Create</a-->
            </h4>
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/redeemrenewpawntransaction/store') }}/{{$transaction_type }}" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <span style="display:block; margin-bottom: .5rem;">Canceled Transaction <small class=" text-muted"><i>(For renewal used only)</i></small></span>
                                    <label class="switch switch-lg switch-icon switch-info">
                                        <input type="checkbox" name="canceled_transaction" class="switch-input" <?php echo ($canceled_transaction == 'on') ? 'checked=""' : ''; ?>>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <?php
                                       $pawn_ticket_number = Request::get('pawn_ticket_number');
                                       $pawn_ticket_number_increment = $pawn_ticket_number_increment;

                                       if ($pawn_ticket_number == 0 && $pawn_ticket_number != $pawn_ticket_number_increment) {
                                            //echo 'one';
                                            $pawn_ticket_number = $pawn_ticket_number_increment;

                                       } elseif($pawn_ticket_number != 0 && $pawn_ticket_number == $pawn_ticket_number_increment) {
                                            //echo 'two';
                                            $pawn_ticket_number = $pawn_ticket_number;

                                       } else {
                                            //echo 'three';
                                            $pawn_ticket_number = old('pawn_ticket_number');
                                       }

                                    ?>

                                    {{-- $pawn_ticket_number --}}
                                    {{-- $pawn_ticket_number_increment --}}
                                ...
                                <!--div class="col-md-4">
                                    <label for="pawnticketnumber">Pawn Ticket No.</label>
                                    <input type="text" name="pawn_ticket_number" value="{{-- old('pawn_ticket_number') --}}" class="form-control" id="pawn-ticket-no" placeholder="Pawn Ticket No.">
                                </div-->                           

                                <div class="col-md-4">
                                    <label for="refpawnticketnumber">Ref Pawn Ticket No. <small class=" text-muted"><i>(For renewal used only)</i></small></label>
                                    <input type="text" name="ref_pawn_ticket_number" value="{{ old('ref_pawn_ticket_number') }}" class="form-control" id="ref-pawn-ticket-number" placeholder="Reference Pawn Ticket Number">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12">
                                    ...
                                    <input type="text" name="full_name" value="{{ ucwords(strtolower(old('full_name'))) }}" class="form-control" id="full-name" placeholder="Full Name">
                                </div>
                            ...
                            <!--div class="row">
                                ...
                                <div class="form-group col-md-12 d-none">
                                    <label for="completeaddress">Complete Address</label>
                                     ...
                                     <textarea name="complete_address" class="form-control" rows="2" id="complete-address">{{-- ucwords(strtolower(old('complete_address'))) --}}</textarea>
                                </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <input type="text" name="loan_amount_in_numbers" value="{{ old('loan_amount_in_numbers') }}" class="form-control" id="loan-amount-in-numbers" placeholder="Loan Amount">
                                    </div>                        

                                    <div class="col-md-4">

                                        <label for="interestrateinnumbers">Interest Rate</label>
                                        <input type="text" name="interest_rate_in_numbers" value="{{ old('interest_rate_in_numbers') }}" class="form-control" id="interest-rate-in-numbers" placeholder="Interest Rate">
                                    </div>
                                ...
                                <!--div class="col-md-3 d-none">
                                    ...
                                    <input type="text" name="appraised_value_in_numbers" value="{{-- old('appraised_value_in_numbers') --}}" class="form-control" id="appraisedvalueinnumbers" placeholder="Appraised Value">
                                </div-->
                            ...
                            <div class="form-group row">
                                ...
                                <!--div class="col-md-6 d-none">  
                                    ...
                                    <textarea id="textarea-input" name="description_of_the_pawn" value="{{-- old('description_of_the_pawn') --}}" rows="15" class="form-control" placeholder="Descripton of the pawn">{{-- ucwords(strtolower(old('description_of_the_pawn'))) --}}</textarea>
                                ...
                                <div class="col-md-4"> 
                                    ...
                                    <div class="col-md-12 pr-0 pl-0">
                                        ...
                                        <input type="text" name="principal" value="{{ old('principal') }}" class="form-control" id="principal" placeholder="Principal" readonly="readonly">
                                    </div>    
                                    ...
                                    <div class="col-md-12 pr-0 pl-0">
                                        ...
                                        <input type="text" name="liquidated_damages" value="{{ old('liquidated_damages') }}" class="form-control" id="liquidated-damages" placeholder="Liquidated Damages">
                                    </div>
                                    ...
                                    <!--div class="col-md-12 pr-0 pl-0">
                                        ...
                                        <input type="text" name="effective_interest_rate_in_percent" value="{{-- old('effective_interest_rate_in_percent') --}}" class="form-control" id="effective-interest-rate-in-percent" placeholder="Effectinve Interest Rate in Percent">
                                    </div-->
            ...
            <div class="card-footer">
                <button type="submit" class="btn btn-primary pull-right">Save New Pawn Transaction</button>
            </div>
    ...
    <!--div class="col-md-3">
        <div class="card">
            <div class="card-block">
                    <button type="submit" class="btn btn-block btn-primary btnSave">Save New Pawn Transaction</button>
            </div>
        </div>
    </div-->
