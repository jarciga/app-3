    ...
    <div class="col-md-10 offset-md-1">
        ...
        <div class="card">
            <h4 class="card-header">
                <strong>Renew Pawn Transaction</strong>

                <div class="btn-group pull-right" role="group" aria-label="crud">
                    <a href="{{ url('/renewpawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary">Create</a>
                    <a href="{{ url('/renewpawntransaction/edit') }}/{{$id}}" id="btn-edit-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary">Edit</a>
                </div>
            </h4>
                            ...
                            <input type="hidden" name="loan_status" value="renew-pawn-transaction">
                                ...
                                <div class="form-group row">
                                    ...
                                    <!--div class="col-md-4 d-none">
                                        ...
                                        <div class="input-group">                                                        
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="maturity_date" value="{{-- $maturity_date --}}" class="form-control" disabled id="maturity-date" placeholder="Maturity Date">
                                        </div>
                                    </div-->
                                    ...
                                    <!--div class="col-md-4 d-none">
                                        ...
                                        <div class="input-group">                                                        
                                            <span class="input-group-addon"><i class="fa fa-calendar"></i></span>
                                            <input type="text" name="expiry_date_of_redemption_period" value="{{-- $expiry_date_of_redemption_period --}}" class="form-control" disabled id="expiry-date-of-redemption-period" placeholder="Expiry Date of Redemption Period">
                                        </div> 
                                    </div-->  
