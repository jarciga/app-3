...
<div id="create-renew-pawn-tranaction" class="row">

    <div class="col-md-10 offset-md-1">

        <div class="card">
            <h4 class="card-header">
                <strong>Create | Renew Pawn Transaction</strong>
                <!--a href="{{ url('/renewpawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary pull-right">Create</a-->
            </h4>
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/renewpawntransaction/store') }}" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <input type="hidden" name="loan_status" value="renew-pawn-transaction">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-4">
                                        <label for="refpawnticketnumber">Ref Pawn Ticket No.</label>
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <div class="col-md-12 pr-0 pl-0">                                        
                                        ...
                                        <input type="text" naFVme="interest_in_absolute_amount" value="{{ old('interest_in_absolute_amount') }}" class="form-control" id="interest-in-absolute-amount" placeholder="Interest in Absolute Amount">
                                    </div>
