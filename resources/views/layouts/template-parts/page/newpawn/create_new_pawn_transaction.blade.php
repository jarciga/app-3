...
<div id="new-pawn-transaction" class="row">

    <div class="col-md-10 offset-md-1">

        <div class="card">
            <h4 class="card-header">
                <strong>Create | New Pawn Transaction</strong>
                <!--a href="{{ url('/newpawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary pull-right">Create</a-->
            </h4>
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/newpawntransaction/store') }}" class="form-horizontal">
                            {{ csrf_field() }}
...
<!--input class="currency" data-inputmask="'alias': 'numeric', 'groupSeparator': ',', 'autoGroup': true, 'digits': 2, 'digitsOptional': false, 'prefix': '$ ', 'placeholder': '0'" style="text-align: right;"-->

<!--input class="currency" style="text-align: right;"-->

<!--input class="decimal" data-inputmask="'alias': 'decimal', 'groupSeparator': ',', 'autoGroup': true" style="text-align: right;"-->
