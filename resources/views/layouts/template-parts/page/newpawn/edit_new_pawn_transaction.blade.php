    ...
    <div class="col-md-10 offset-md-1">
        ...
        <div class="card">
            <h4 class="card-header">
                <strong>Edit | New Pawn Transaction</strong>
                <a href="{{ url('/newpawntransaction/create') }}" id="btn-create-customer-and-pawn-transaction" class="btn btn-sm btn-outline-primary pull-right">Create New Pawn Transaction</a>
            </h4>
            ...
            <div class="card-block">
                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                        ...
                        <form method="post" action="{{ url('/newpawntransaction/update') }}/{{$id}}" class="form-horizontal">
                            {{ csrf_field() }}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-6"> 
                                    ...
                                    <div class="col-md-12 pr-0 pl-0">
                                        ...
                                        <input type="text" name="principal" value="{{ $principal }}" class="form-control" id="principal" placeholder="Principal" readonly="readonly">
                                    </div>    
