        ...
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul class="nav">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="/"><i class="icon-speedometer"></i> Dashboard <span class="badge badge-info invisible">NEW</span></a>
                    </li>

                    <!--li class="divider"></li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link" href="/verification"><i class="icon-puzzle"></i> Verification</a>
                    </li-->

                    <li class="divider"></li>
                    <li class="nav-item nav-dropdown">
                        <a class="nav-link" href="/reporting"><i class="icon-puzzle"></i> Reporting</a>
                    </li>
