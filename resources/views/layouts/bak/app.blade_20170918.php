        ...
        $("#btn-search").click(function(e){
            ...
            .done(function(data) {
                ...
                if(data.success === 'success') {
                    ...
                    output += '        <th>Pawn Ticket Number</th>';
                    output += '        <th>Name</th>';
                    output += '        <th>Status</th>';
                    ...
                    output += '    <tr>';
                    output += '        <td>' + v.id + '</td>';
                    output += '        <td><a href="/customer/?customer_id=' + v.customer_id + '">' + v.customer_number + '</a></td>';
                    output += '        <td><a href="/pawn/?pawn_ticket_number=' + v.pawn_ticket_number + '">' + v.pawn_ticket_number + '</a></td>';
                    ...
                    output += '    </tr>';
                        ...
                        $('#myModal #myTabContent #home').html(v.customer_number+ '<br />' + v.first_name + ' ' + v.last_name); 
                        $('#myModal #myTabContent #profile').html(v.customer_number); 
