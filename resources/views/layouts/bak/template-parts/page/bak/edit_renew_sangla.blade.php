...
@section('content')
            ...
            <div class="row" style="margin-top:30px;">
                ...
                <div class="col-md-12">
                    ...
                    <form method="post" action="/edit_renew_sangla/{{ $customer->id }}">
                        {{ csrf_field() }}
                        
                        <input type="hidden" name="loan_status" value="renew-sangla">
                                ...
                                <!--form method="" action=""-->
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-3">
                                            ...
                                            <input type="text" name="last_name" value="{{ $customer->last_name }}" class="form-control" id="last-name" placeholder="Last Name">
                                        </div>                           

                                        <div class="form-group col-sm-3">
                                            <label for="firstname">First Name</label>
                                            <input type="text" name="first_name" value="{{ $customer->first_name }}" class="form-control" id="first-name" placeholder="First Name">
                                        </div>

                                        <div class="form-group col-sm-3">
                                            <label for="middlename">Middle Name</label>
                                            <input type="text" name="middle_name" value="{{ $customer->middle_name }}" class="form-control" id="middle-name" placeholder="Middle Name">
                                        </div>

                                        <div class="form-group col-sm-3">
                                            <label for="suffix">Suffix</label>
                                            <input type="text" name="suffix" value="{{ $customer->suffix }}" class="form-control" id="suffix" placeholder="Suffix">
                                        </div>
                                    ...
                                    <div class="row">                                
                                        ...
                                        <div class="form-group col-sm-2">
                                            ...
                                            <input type="text" name="rm_flr_unit_no" value="{{ $customer->rm_flr_unit_no }}" class="form-control" id="rm-flr-unit-no" placeholder="Rm./Flr./Unit No.">
                                        </div>

                                        <div class="form-group col-sm-4">
                                            <label for="bldgname">Bldg. Name</label>
                                            <input type="text" name="bldg_name" value="{{ $customer->bldg_name }}" class="form-control" id="bldg-name" placeholder="Bldg. Name">
                                        </div>

                                        <div class="form-group col-sm-2">
                                            <label for="houselotandblkno">House/Lot & Blk. No.</label>
                                            <input type="text" name="house_lot_and_blk_no" value="{{ $customer->house_lot_and_blk_no }}" class="form-control" id="house-lot-and-blk-no" placeholder="House/Lot & Blk. No.">
                                        </div>

                                        <div class="form-group col-sm-2">
                                            <label for="streetname">Street Name</label>
                                            <input type="text" name="street_name" value="{{ $customer->street_name }}" class="form-control" id="street-name" placeholder="Street Name">
                                        </div>

                                        <div class="form-group col-sm-2">
                                            <label for="subdivision">Subdivision</label>
                                            <input type="text" name="subdivision" value="{{ $customer->subdivision }}" class="form-control" id="subdivision" placeholder="Subdivision">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <input type="text" name="barangay_district_locality" value="{{ $customer->barangay_district_locality }}" class="form-control" id="barangay-district-locality" placeholder="Barangay/District/Locality">
                                        </div>                           

                                        <div class="form-group col-sm-4">
                                            <label for="citymunicipality">City/Municipality</label>
                                            <input type="text" name="city_municipality" value="{{ $customer->city_municipality }}" class="form-control" id="city-municipality" placeholder="City/Municipality">
                                        </div>

                                        <div class="form-group col-sm-4">
                                            <label for="province">Province</label>
                                            <input type="text" name="province" value="{{ $customer->province }}" class="form-control" id="province" placeholder="Province">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <input type="text" name="identification_card" value="{{ $customer->identification_card }}" class="form-control" id="identification-card" placeholder="Identification Card">
                                        </div>                           

                                        <div class="form-group col-sm-6">
                                            <label for="contactnumber">Contact Number</label>
                                            <input type="text" name="contact_number" value="{{ $customer->contact_number }}" class="form-control" id="contact-number" placeholder="Contact Number">
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-12">
                                            ...
                                            <div class="form-actions float-right">
                                                ...
                                                <a class="btn btn-primary btnNext">Continue To Edit Renew Sangla Transaction</a>
                                        ...
                                        <div class="form-group col-sm-4">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="text" name="date_loan_granted" value="{{ date('Y/m/d', strtotime($mortgages->date_loan_granted)) }}" class="form-control" id="date-loan-granted" placeholder="Date loan Granted">
                                                </div>                           

                                                <div class="form-group col-sm-12">
                                                    <label for="maturitydate">Maturity Date</label>
                                                    <input type="text" name="maturity_date" value="{{ date('Y/m/d', strtotime($mortgages->maturity_date)) }}" class="form-control" id="maturity-date" placeholder="Maturity Date
                                ">
                                                </div>

                                                <div class="form-group col-sm-12">
                                                    <label for="expirydateofredemptionperiod">Expiry Date of Redemption Period</label>
                                                    <input type="text" name="expiry_date_of_redemption_period" value="{{ date('Y/m/d', strtotime($mortgages->expiry_date_of_redemption_period)) }}" class="form-control" id="expiry-date-of-redemption-period" placeholder="Expiry Date of Redemption Period">
                                                </div>                           
                                        ...
                                        <div class="form-group col-sm-4 ml-sm-auto">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="form-group col-sm-12">
                                                    ...
                                                    <input type="text" name="pawn_ticket_no" value="{{ $mortgages->pawn_ticket_number }}" class="form-control" id="pawn-ticket-no" placeholder="Pawn Ticket No.">
                                                </div>                           

                                                <div class="form-group col-sm-12">
                                                    <label for="trackingno">Redeem No.</label>
                                                    <input type="text" name="tracking_no" value="{{ $mortgages->tracking_no }}" class="form-control" id="tracking-no" placeholder="Redeem No.">
                                                </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group col-sm-6">
                                            ...
                                            <div class="form-actions float-right">
                                                ...
                                                <button type="submit" class="btn btn-primary btnSave">Update Renew Sangla Transaction</button>
                                                <button type="reset" class="btn btn-default">Reset</button>
