...
class RenewPawnTransactionController extends Controller
{
    /**
    ...
    public function index()
    {
       ...
       // return 'NewPawnTransactionController index';
        //return view('layouts.template-parts.page.renewpawn.create_renew_pawn_transaction');
        return view('layouts.template-parts.page.renewpawn.datatables_renew_pawn_transaction');
    }
    ...
    public function store(Request $request)
    {
        ...
        //if($request->ajax()){   
            ...
            if ($validator->fails())
            {
                return redirect('/renewpawntransaction/create')
                ...
                if ( $customer->save() ) {
                    ...
                    if ( $mortgage->save() ) {
                        ...
                        if ( $pawn->save() ) {
                            ...
                            //return redirect('/renewpawntransaction/edit' . $customer->id, ['customer_id' => $customer->id, 'mortgage_id' => $mortgage->id, 'pawn_id' => $pawn->id])
                                //->withInput();

                            return redirect()->action('RenewPawnTransactionController@edit', ['id' => $customer->id])->with('status', 'Saved Successfully...')->withInput();
        ...
        //return view('layouts.template-parts.page.renewpawn.edit_renew_pawn_transaction');
    ...
    public function show($id)
    {
        ...
        $mortgages = Customer::find($customer_id)->mortgages()->where('loan_status', 'renew-pawn-transaction')->first();
        ...
        return view('layouts.template-parts.page.renewpawn.show_renew_pawn_transaction', $data);
    }
    ...
    {   
        ...
        return view('layouts.template-parts.page.renewpawn.edit_renew_pawn_transaction', $data);
    }
    ...
    public function update(Request $request, $id)
    {
       //dd($id);
        ...
        $mortgages = Customer::find($customer->id)->mortgages()->where('loan_status', 'renew-pawn-transaction')->first();
        //dd($mortgages);
        $pawn = Mortgage::find($mortgages->id)->pawn;
        ...
        //if($request->ajax()){   
            ...
            if ($validator->fails())
            {
                return redirect('/renewpawntransaction/edit')
                            ->withErrors($validator)
                            ->withInput();
                ...
                if ( $customer->save() ) {
                    ...
                    if ( $mortgages->save() ) {
                        ...
                        if ( $pawn->save() ) {
                            ...
                            return redirect()->action('RenewPawnTransactionController@edit', ['id' => $customer->id])->with('status', 'Updated Successfully...')->withInput();
    ...
    public function getDataTablesObjectData(Request $request, Datatables $datatables)
    {
        ...
        return Datatables::of($query)->addColumn('action', function ($query) {
                    ...
                    return '<a href="'.url('/renewpawntransaction/show').'/'.$query->customer_id.'" title="View">View</a> | <a href="'.url('/renewpawntransaction/edit').'/'.$query->customer_id.'" title="Edit">Edit </a> | Delete';
