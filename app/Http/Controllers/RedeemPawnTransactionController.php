...
class RedeemPawnTransactionController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        //return 'RedeemPawnTransactionController index';
        //return view('layouts.template-parts.page.redeempawn.create_redeem_pawn_transaction');
        return view('layouts.template-parts.page.redeempawn.datatables_redeem_pawn_transaction');
    }
    ...
    public function store(Request $request)
    {
        ...
        //if($request->ajax()){   
            ...
            if ($validator->fails())
            {
                return redirect('/redeempawntransaction/create')
                ...
                if ( $customer->save() ) {
                    ...
                    if ( $mortgage->save() ) {
                        ...
                        if ( $pawn->save() ) {
                            ...
                            //return redirect('/redeempawntransaction/edit' . $customer->id, ['customer_id' => $customer->id, 'mortgage_id' => $mortgage->id, 'pawn_id' => $pawn->id])
                                //->withInput();

                            return redirect()->action('redeempawntransactionController@edit', ['id' => $customer->id])->with('status', 'Saved Successfully...')->withInput();
        ...
        //return view('layouts.template-parts.page.redeempawn.edit_redeem_pawn_transaction');
    ...
    public function show($id)
    {
        ...
        $mortgages = Customer::find($customer_id)->mortgages()->where('loan_status', 'redeem-pawn-transaction')->first();
        ...
        return view('layouts.template-parts.page.redeempawn.show_redeem_pawn_transaction', $data);
    }
    ...
    {   
        ...
        return view('layouts.template-parts.page.redeempawn.edit_redeem_pawn_transaction', $data);
    }
    ...
    public function update(Request $request, $id)
    {
       //dd($id);
        ...
        $mortgages = Customer::find($customer->id)->mortgages()->where('loan_status', 'redeem-pawn-transaction')->first();
        //dd($mortgages);
        $pawn = Mortgage::find($mortgages->id)->pawn;
        ...
        //if($request->ajax()){   
            ...
            if ($validator->fails())
            {
                return redirect('/redeempawntransaction/edit')
                            ->withErrors($validator)
                            ->withInput();
                ...
                if ( $customer->save() ) {
                    ...
                    if ( $mortgages->save() ) {
                        ...
                        if ( $pawn->save() ) {
                            ...
                            return redirect()->action('redeempawntransactionController@edit', ['id' => $customer->id])->with('status', 'Updated Successfully...')->withInput();
    ...
    public function getDataTablesObjectData(Request $request, Datatables $datatables)
    {
        ...
        /*$query = DB::table('customers')
                       ...
                       ->select('customers.id AS redeem_pawn_transaction_id', 'customers.*', 'mortgages.*', 'pawns.*');*/
        ...
        return Datatables::of($query)->addColumn('action', function ($query) {
                    ...
                    return '<a href="'.url('/redeempawntransaction/show').'/'.$query->customer_id.'" title="View">View</a> | <a href="'.url('/redeempawntransaction/edit').'/'.$query->customer_id.'" title="Edit">Edit </a> | Delete';
